...
class ImportPage(ctk.CTkFrame):
    ...
    def load_images(self):
        try:
            ...
            self.box_img = ctk.CTkImage(light_image=Image.open(r"C:\Service_Robot\UI\assets\import_page\box.png"), size=(600, 260))
    ...
    def on_comfirmbtn_click(self):
        print(f"page: Import page > Goto Notify page")
        self.pack_forget()
    ...
    def back(self):
        print("Import Page: back to Main page.")
        self.pack_forget()

        if self.pages and 'slot_page' in self.pages:
